...
public class Demo9_Search {
    public static void main(String[] args) {
        try {
            ...
            //构建Scan对象
            Scan scan = new Scan();
            //指定行键范围区间：>=begin and <= end
            byte[] begin = Bytes.toBytes("1001");
            byte[] end = Bytes.toBytes("1002");
            scan.withStartRow(begin, true);
            scan.withStopRow(end, true);
            //执行读取操作
